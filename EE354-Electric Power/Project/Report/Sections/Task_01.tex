...
Following charts are the flow charts with line references. Figures~\ref{fig:project_flow}, \ref{fig:task1_code_flow}, and \ref{fig:task1_nr_flow} are the exported flowcharts corresponding to the final script.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\linewidth]{\detokenize{Figures/Project_Flow.png}}
...
The \textbf{real and imaginary parts} are shown in Tables~\ref{tab:ybus_real} and \ref{tab:ybus_imag}.

\begin{table}[H]
\centering
\caption{\textbf{Real} part of \(Y_{bus}\) (p.u.).}
\label{tab:ybus_real}
\scriptsize
\resizebox{\textwidth}{!}{
...
\begin{table}[H]
\centering
\caption{\textbf{Imaginary} part of \(Y_{bus}\) (p.u.).}
\label{tab:ybus_imag}
\scriptsize
\resizebox{\textwidth}{!}{
\begin{tabular}{c|rrrrrrrrr}
...
\begin{table}[H]
  \centering
  \caption{\textbf{Second-iteration} bus snapshot.}
...
\begin{table}[H]
  \centering
  \caption{Final bus profile from custom NR solver.}
  \label{tab:task1_finalV}
  \begin{tabular}{ccccc}
    \toprule
    Bus & \(|V|\) (p.u.) & Angle (deg) & \(P_{injection}\) (MW) & \(Q_{injection}\) (MVAr) \\
    \midrule
    1 & 1.040000 & 0.000000 & 71.641012 & 27.045892 \\
    2 & 1.025000 & 9.280008 & 163.000003 & 6.653621 \\
    3 & 1.025000 & 4.664753 & 85.000001 & -10.859733 \\
    4 & 1.025788 & -2.216787 & -0.000008 & 0.000006 \\
    5 & 0.995631 & -3.988804 & -125.000009 & -49.999972 \\
    6 & 1.012654 & -3.687395 & -90.000008 & -29.999988 \\
    7 & 1.025769 & 3.719704 & 0.000034 & 0.000033 \\
    8 & 1.015883 & 0.727538 & -100.000018 & -34.999992 \\
    9 & 1.032353 & 1.966718 & 0.000016 & 0.000008 \\
    \bottomrule
  \end{tabular}
\end{table}
...
The source code prints student identification and timestamp at runtime. Executed outputs are as follows, with screenshots provided in Figure~\ref{fig:task1_execution_proof}.

\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\linewidth]{\detokenize{Figures/Outputs/Task01-Program_Output_1.png}} &
    \includegraphics[width=0.45\linewidth]{\detokenize{Figures/Outputs/Task01-Program_Output_2.png}} \\
  \end{tabular}
  \\[0.5cm]
  \begin{tabular}{c}
    \includegraphics[width=0.45\linewidth]{\detokenize{Figures/Outputs/Task01-Program_Output_3.png}}
  \end{tabular}
  \caption{Execution proof showing program output with student ID and timestamp.}
  \label{fig:task1_execution_proof}
\end{figure}
